...
private extension CalendarDateCollectionViewCell {
	...
	func updateSelectionStatus() {
		...
		if day.isSelected {
			...
			var isWithinMonth = false
			if day.date.compare(Date()) == .orderedDescending || calendar.isDate(day.date, inSameDayAs: Date()){
				isWithinMonth = day.isWithinDisplayedMonth
			}
			applyDefaultStyle(isWithinDisplayedMonth: isWithinMonth)
		}
	}
...
//		accessibilityTraits.remove(.selected)
		...
		numberLabel.textColor = isWithinDisplayedMonth ? .black : .gray
